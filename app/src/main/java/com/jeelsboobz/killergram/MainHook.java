        ...
        if (hookPackages.contains(lpparam.packageName)) {
            try {
                ...
                if (lpparam.packageName.equals("ir.ilmili.telegraph")) {
                    ...
                    Class<?> MessagesControllerTelegraph = XposedHelpers.findClassIfExists("org.telegram.messenger.gb0", lpparam.classLoader);
                    ...
                    Class<?> MessagesControllerTelegraph2 = XposedHelpers.findClassIfExists("org.telegram.messenger.jv", lpparam.classLoader);
                    ...
                    Class<?> UserConfigTelegraph = XposedHelpers.findClassIfExists("org.telegram.messenger.wy0", lpparam.classLoader);
