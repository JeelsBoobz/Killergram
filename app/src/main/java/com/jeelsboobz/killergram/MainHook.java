        ...
        if (hookPackages.contains(lpparam.packageName)) {
            try {
                ...
                if (lpparam.packageName.equals("ir.ilmili.telegraph")) {
                    ...
                    Class<?> MessagesControllerTelegraph = XposedHelpers.findClassIfExists("org.telegram.messenger.ga0", lpparam.classLoader);
                    ...
                    Class<?> MessagesControllerTelegraph2 = XposedHelpers.findClassIfExists("org.telegram.messenger.tu", lpparam.classLoader);
